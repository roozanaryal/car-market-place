  ...
  return (
    <div className="w-full">
      <form onSubmit={handleTextSearch}>
        <div className="search-container flex items-center max-w-2xl mx-auto p-2 gap-2">
          {/* Image Search Toggle */}
          <button
            type="button"
      ...
      {isImageSearchActive && (
        <div className="mt-6">
          <form onSubmit={handleImageSearch} className="space-y-4">
            <div className={`dropzone p-8 text-center ${isDragActive ? "dropzone-active" : ""}`}>
              {imagePreview ? (
                ...
                <div {...getRootProps()} className="cursor-pointer">
                  <input {...getInputProps()} />
                  <div className="flex flex-col items-center space-y-4">
                    <div className="p-4 bg-neutral-100 rounded-full shadow-inner">
