...
import { bodyTypes, carMakes, faqItems, featuredCars as mockFeaturedCars } from "@/lib/data";
import { Car as CarType } from "@/components/car-card";

export default async function Home() {
  // Use mock data instead of API call
  const featuredCars: CarType[] = mockFeaturedCars;
    ...
    <div className="flex flex-col pt-20">
      ...
      <section className="relative py-16 md:py-28 dotted-background">
        <div className="max-w-4xl mx-auto text-center">
          <div className="mb-8">
            <h1 className="text-5xl md:text-8xl mb-4 gradient-title bg-red-500">
